...
ln -s /etc/letsencrypt/live/warden.psalad.link/privkey.pem $nginx_config_path/privkey.pem
ln -s /etc/letsencrypt/live/warden.psalad.link/fullchain.pem $nginx_config_path/fullchain.pem
