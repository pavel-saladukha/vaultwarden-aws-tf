...
resource "aws_s3_bucket_object" "notifier" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "maint-script" {
  bucket                 = aws_s3_bucket.config.id
  key                    = "maintenance.sh"
...
resource "aws_s3_bucket_object" "update_script" {
  bucket                 = aws_s3_bucket.config.id
  key                    = "update.sh"
...
resource "aws_s3_bucket_object" "warden_jail" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "warden_filter" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "warden_admin_jail" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "warden_admin_filter" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "nginx_bot_jail" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "nginx_http_auth_jail" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "nginx_301_jail" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "nginx_301_filter" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "nginx_400_jail" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "nginx_400_filter" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "nginx_404_jail" {
  bucket                 = aws_s3_bucket.config.id
...
resource "aws_s3_bucket_object" "nginx_404_filter" {
  bucket                 = aws_s3_bucket.config.id
